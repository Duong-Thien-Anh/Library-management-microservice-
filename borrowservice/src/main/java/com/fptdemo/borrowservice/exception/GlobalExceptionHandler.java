 ...
 */
@RestControllerAdvice(basePackages = "com.fptdemo.borrowservice.controller")
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleBorrowNotAllowed(BorrowNotAllowedException ex) {
